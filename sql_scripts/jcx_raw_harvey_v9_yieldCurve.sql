...
-- Compare #t17a_final row counts
SELECT COUNT(*) FROM #t17a_final  -- should be the same between v9 and v10

-- Compare #t17_stacked row counts
SELECT COUNT(*) FROM #t17_stacked
